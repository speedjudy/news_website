  ...
  switch ($_GET['view']) {
    ...
    case 'types':
      ...
      switch ($_GET['sub_view']) {
        case '':
          // page header
          page_header($control_panel['title'] . " &rsaquo; " . __("Types"));

          // get data
          $get_rows = $db->query("SELECT * FROM system_types") or _error("SQL_ERROR");
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              $rows[] = $row;
            }
        ...
        case 'edit':
          ...
          // get data
          $get_data = $db->query(sprintf("SELECT * FROM system_types WHERE id = %s", secure($_GET['id'], 'int'))) or _error("SQL_ERROR");
          if ($get_data->num_rows == 0) {
            _error(404);
          }
          $data = $get_data->fetch_assoc();
          ...
          // page header
          page_header($control_panel['title'] . " &rsaquo; " . __("Types") . " &rsaquo; " . $data['name']);
          break;
