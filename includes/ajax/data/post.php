        ...
        switch ($_POST['handle']) {
          case 'cover-user':
            ...
            if (!$user->_data['user_album_covers']) {
              ...
              $db->query(sprintf("INSERT INTO posts_photos_albums (user_id, user_type, title, privacy) VALUES (%s, 'user', 'Cover Photos', 'private')", secure($user->_data['user_id'], 'int'))) or _error("SQL_ERROR_THROWEN");
            ...
            $db->query(sprintf("INSERT INTO posts (user_id, user_type, post_type, time, privacy) VALUES (%s, 'user', 'profile_cover', %s, 'private')", secure($user->_data['user_id'], 'int'), secure($date))) or _error("SQL_ERROR_THROWEN");
          ...
          case 'picture-user':
            ...
            $db->query(sprintf("INSERT INTO posts (user_id, user_type, post_type, time, privacy) VALUES (%s, 'user', 'profile_picture', %s, 'private')", secure($user->_data['user_id'], 'int'), secure($date))) or _error("SQL_ERROR_THROWEN");
            $post_id = $db->insert_id;
          ...
          case 'cover-page':
            ...
            if (!$page['page_album_covers']) {
              /* create new cover album */
              $db->query(sprintf("INSERT INTO posts_photos_albums (user_id, user_type, title, privacy) VALUES (%s, 'page', 'Cover Photos', 'private')", secure($page['page_id'], 'int'))) or _error("SQL_ERROR_THROWEN");
            ...
            /* insert updated cover photo post */
            $db->query(sprintf("INSERT INTO posts (user_id, user_type, post_type, time, privacy) VALUES (%s, 'page', 'page_cover', %s, 'private')", secure($page['page_id'], 'int'), secure($date))) or _error("SQL_ERROR_THROWEN");
            $post_id = $db->insert_id;
            /* insert new cover photo to album */
