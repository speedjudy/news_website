        ...
        <div class="card mt20">
          ...
          <div class="card-body">
            ...
            {if $wallet_withdraw_monetization_amount}
              <div class="alert alert-success mb20">
                <i class="fas fa-check-circle mr5"></i>
                {__("Congratulation! Your wallet credit replenished successfully with")} <span class="badge badge-pill badge-lg badge-light">{print_money($wallet_withdraw_monetization_amount|number_format:2)}</span> {__("from your monetization credit")}
              </div>
            {/if}
            ...
            {if $wallet_monetization_payment_amount}
              <div class="alert alert-success mb20">
                <i class="fas fa-check-circle mr5"></i>
                {__("Your")} <span class="badge badge-pill badge-lg badge-light">{print_money($wallet_monetization_payment_amount|number_format:2)}</span> {__("payment transaction successfuly done")}
              </div>
            {/if}
              ...
              <div class="col-md-7">
                ...
                <div>
                  ...
                  {if $user->_data['can_monetize_content'] && $system['monetization_money_transfer_enabled']}
                    <button class="btn btn-primary btn-block mb10" data-toggle="modal" data-url="#wallet-withdraw-monetization">
                      <i class="fa fa-comment-dollar mr5"></i>{__("Monetization Credit")}
                    </button>
                  {/if}
                </div>
              </div>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {elseif $transaction['node_type'] == "package_payment"}
                                {__("Buy Pro Package")}
                              {elseif $transaction['node_type'] == "subscribe_user"}
                                {__("Subscribe to User")}
