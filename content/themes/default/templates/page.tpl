        ...
        {if $view == ""}
            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i>{__($spage['posts_count'])} {__("Posts")}
                    </div>
                  </li>
                  <!-- posts -->
                  <!-- photos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i>{__($spage['photos_count'])} {__("Photos")}
                    </div>
                  </li>
                  <!-- photos -->
                  <!-- videos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i>{__($spage['videos_count'])} {__("Videos")}
                    </div>
                  </li>
                  <!-- videos -->
                  <!-- category -->
            ...
            {if $spage['subscribers_count'] > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <span class="badge badge-pill badge-info ml5">{$spage['subscribers_count']}</span>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
          ...
          <div class="order-3 col-lg-6 order-lg-2">
            {if $spage['needs_subscription']}
              {include file='_need_subscription.tpl' node_type='page' node_id=$spage['page_id'] price=$spage['page_monetization_price']}
            {else}
              <!-- publisher -->
              {if $spage['i_admin']}
                ...
                <ul class="side-nav">
                  ...
                  <li {if $sub_view == "info"}class="active" {/if}>
                    <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/info">
                      <i class="fa fa-info-circle fa-fw mr10" style="color: #2b53a4;"></i>{__("Page Information")}
                    </a>
                  </li>
                  <li {if $sub_view == "admins"}class="active" {/if}>
                    <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/admins">
                      <i class="fa fa-users fa-fw mr10" style="color: #8bc34a"></i>{__("Admins")}
                    </a>
                  </li>
                  ...
                  {if $user->_data['user_id'] == $spage['page_admin']}
                    <li {if $sub_view == "delete"}class="active" {/if}>
                      <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/delete">
                        <i class="fa fa-trash fa-fw mr10" style="color: #f44336;"></i>{__("Delete Page")}
                      </a>
                    </li>
                  {/if}
                </ul>
            ...
            <div class="card">
              ...
              {elseif $sub_view == "info"}
                <div class="card-header with-icon with-nav">
                  <!-- panel title -->
                  <div class="mb20">
                    <i class="fa fa-info-circle mr10" style="color: #2b53a4;"></i>{__("Page Information")}
                  </div>
                  <!-- panel title -->
                  ...
                  <div class="pl-md-4">
                    <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=page&do=edit&edit=monetization&id={$spage['page_id']}">
                      ...
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="page_monetization_price" value="{$spage['page_monetization_price']}">
                          <span class="form-text">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <i class="fas fa-users mr10"></i>{__("Page Subscribers")}
                        </div>
              ...
              {elseif $sub_view == "delete"}
                <div class="card-header with-icon">
                  <i class="fa fa-trash mr10" style="color: #f44336;"></i>{__("Delete Page")}
                </div>
                <div class="card-body">
