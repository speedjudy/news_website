                  ...
                  <div class="card card-pricing shadow-sm">
                    ...
                    <ul class="list-group list-group-flush text-center">
                      <li class="list-group-item">
                        <i class="fa fa-check green mr10"></i>{__("Featured member")}
                      </li>
                      {if $system['packages_ads_free_enabled']}
                        <li class="list-group-item">
                          <i class="fa fa-check green mr10"></i>{__("No Ads")}
                        </li>
                      {/if}
                      <li class="list-group-item">
                    ...
                    <div class="card-footer bg-transparent">
                      {if $user->_logged_in}
                        ...
                        {else}
                          <button class="btn btn-block rounded-pill btn-danger" data-toggle="modal" data-url="#payment" data-options='{ "handle": "packages", "id": {$package["package_id"]}, "price": "{$package["price"]}", "name": "{$package["name"]}", "img": "{$package["icon"]}" }'>
      ...
      <div class="col-12 offcanvas-mainbar">
        <div class="card text-center">
          <div class="card-body">
            ...
            <p class="text-xlg mt10">{__("You are now")} <span class="badge badge-danger">{__($user->_data['package_name'])}</span> {__("member")}</p>
