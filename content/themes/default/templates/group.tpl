        ...
        {if $view == ""}
            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i>{__($group['posts_count'])} {__("Posts")}
                    </div>
                  </li>
                  <!-- posts -->
                  <!-- photos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i>{__($group['photos_count'])} {__("Photos")}
                    </div>
                  </li>
                  <!-- photos -->
                  <!-- videos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i>{__($group['videos_count'])} {__("Videos")}
                    </div>
                  </li>
                  <!-- videos -->
                  <!-- category -->
            ...
            {if $group['subscribers_count'] > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <span class="badge badge-pill badge-info ml5">{$group['subscribers_count']}</span>
                </div>
          ...
          <div class="order-2 col-lg-8 order-lg-1">
            {if $group['needs_subscription']}
              {include file='_need_subscription.tpl' node_type='group' node_id=$group['group_id'] price=$group['group_monetization_price']}
            {else}
              <!-- super admin alert -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i>{__("Subscribers")}
                </div>
                <!-- panel title -->
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/groups/{$group['group_name']}/subscribers">
                      {__("Subscribers")}
                      <span class="badge badge-pill badge-info">{$group['subscribers_count']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/groups/{$group['group_name']}/invites">{__("Invites")}</a>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i>{__("Invites")}
                </div>
                <!-- panel title -->
                  ...
                  {if $group['group_privacy'] != "public"}
                    <li {if $sub_view == "requests"}class="active" {/if}>
                      <a href="{$system['system_url']}/groups/{$group['group_name']}/settings/requests">
                        <i class="fa fa-user-plus fa-fw mr5" style="color: #2b53a4;"></i>{__("Join Requests")}
                      </a>
                    </li>
                  {/if}
                  <li {if $sub_view == "members"}class="active" {/if}>
                    <a href="{$system['system_url']}/groups/{$group['group_name']}/settings/members">
                      <i class="fa fa-users fa-fw mr5" style="color: #8bc34a"></i>{__("Members")}
                    </a>
                  </li>
                  ...
                  {if $user->_data['user_id'] == $group['group_admin']}
                    <li {if $sub_view == "delete"}class="active" {/if}>
                      <a href="{$system['system_url']}/groups/{$group['group_name']}/settings/delete">
                        <i class="fa fa-trash fa-fw mr5" style="color: #f44336;"></i>{__("Delete Group")}
                      </a>
                    </li>
                  {/if}
                </ul>
          ...
          <div class="col-lg-9">
            ...
            <div class="card">
              ...
              {elseif $sub_view == "requests"}
                <div class="card-header with-icon">
                  <i class="fa fa-user-plus mr10" style="color: #2b53a4;"></i>{__("Member Requests")}
                </div>
                <div class="card-body">
                  {if $group['requests']}
                    <ul>
              ...
              {elseif $sub_view == "members"}
                <div class="card-header with-icon">
                  <i class="fa fa-users mr10" style="color: #8bc34a"></i>{__("Members")}
                </div>
                <div class="card-body">
                  <!-- admins -->
                  ...
                  <div class="pl-md-4">
                    <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=group&do=edit&edit=monetization&id={$group['group_id']}">
                      ...
                      <div class="form-group form-row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="group_monetization_price" value="{$group['group_monetization_price']}">
                          <span class="form-text">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <i class="fas fa-users mr10"></i>{__("Group Subscribers")}
                        </div>
              ...
              {elseif $sub_view == "delete"}
                <div class="card-header with-icon">
                  <i class="fa fa-trash mr10" style="color: #f44336;"></i>{__("Delete Group")}
                </div>
                <div class="card-body">
                  <div class="alert alert-warning">
                    <div class="icon">
