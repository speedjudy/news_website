        ...
        {if $view == ""}
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i>{__($profile['posts_count'])} {__("Posts")}
                    </div>
                  </li>
                  <!-- posts -->
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i>{__($profile['photos_count'])} {__("Photos")}
                    </div>
                  </li>
                  <!-- photos -->
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i>{__($profile['videos_count'])} {__("Videos")}
                    </div>
                  </li>
                  <!-- videos -->
          ...
          <div class="order-2 col-lg-3 order-lg-3">
            ...
            {if $user->_logged_in && $user->_data['user_id'] != $profile['user_id'] && $system['gifts_enabled']}
              {if $user->_data['can_send_gifts'] && ($profile['user_privacy_gifts'] == "public" || ($profile['user_privacy_gifts'] == "friends" && $profile['we_friends']))}
                <button type="button" class="btn btn-block btn-md bg-gradient-pink border-0 rounded-pill mb20" data-toggle="modal" data-url="#gifts" data-options='{ "uid": {$profile["user_id"]} }'>
            ...
            {if $profile['subscribers_count'] > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <span class="badge badge-pill badge-info ml5">{$profile['subscribers_count']}</span>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
          ...
          <div class="order-3 col-lg-6 order-lg-2">
            {if $profile['needs_subscription']}
              {include file='_need_subscription.tpl' node_type='user' node_id=$profile['user_id'] price=$profile['user_monetization_price']}
            {else}
              <!-- publisher -->
              {if $user->_logged_in}
                {if $user->_data['user_id'] == $profile['user_id']}
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i>{__("Followings")}
                </div>
                <!-- panel title -->
