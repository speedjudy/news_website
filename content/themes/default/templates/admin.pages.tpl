    ...
    <div class="card-body">
      ...
      <ul class="nav nav-tabs mb20">
        ...
        {if $system['monetization_enabled']}
          <li class="nav-item">
            <a class="nav-link" href="#page_monetization" data-toggle="tab">
              <i class="fa fa-comment-dollar fa-fw mr5"></i><strong>{__("Monetization")}</strong>
            </a>
          </li>
        {/if}
      </ul>
          ...
          {if $data['can_monetize_content']}
            <form class="js_ajax-forms" data-url="admin/pages.php?do=edit_page&edit=monetization&id={$data['page_id']}">
              ...
              <div class="form-group form-row">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" name="page_monetization_price" value="{$data['page_monetization_price']}">
