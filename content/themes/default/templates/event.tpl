            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i>{__($event['posts_count'])} {__("Posts")}
                    </div>
                  </li>
                  <!-- posts -->
                  <!-- photos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i>{__($event['photos_count'])} {__("Photos")}
                    </div>
                  </li>
                  <!-- photos -->
                  <!-- videos -->
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i>{__($event['videos_count'])} {__("Videos")}
                    </div>
                  </li>
                  <!-- videos -->
                  <li>
                ...
                <ul class="side-nav">
                  <li {if $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/events/{$event['event_id']}/settings">
                      <i class="fa fa-cog fa-fw mr5"></i>{__("Event Settings")}
                    </a>
                  </li>
                  <li {if $sub_view == "delete"}class="active" {/if}>
                    <a href="{$system['system_url']}/events/{$event['event_id']}/settings/delete">
                      <i class="fa fa-trash fa-fw mr5" style="color: #f44336;"></i>{__("Delete Event")}
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div class="col-lg-9">
            ...
            <div class="card">
              ...
              {elseif $sub_view == "delete"}
                <div class="card-header with-icon">
                  <i class="fa fa-trash mr10" style="color: #f44336;"></i>{__("Delete Event")}
                </div>
                <div class="card-body">
                  <div class="alert alert-warning">
                    <div class="icon">
